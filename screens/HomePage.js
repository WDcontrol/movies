...
import { initAsync } from '../redux/actions/FavoritesAction';
import { initWatched } from '../redux/actions/WatchedAction';
...
class HomePage extends React.Component {
  ...
  componentDidMount() {
    this.props.actions.initWatched();
...
const mapActionsToProps = (payload) => ({
  actions: {
    ...
    initWatched: bindActionCreators(initWatched, payload)
  }
});
